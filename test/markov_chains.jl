...
@testset "markov_chain" begin
    @testset "inftime_state_acyclic1" begin
    ...
    @testset "inftime_state_irreducible1" begin
        chain = ContMarkovChain()
        n0 = add_state!(chain)
        n1 = add_state!(chain)
        n2 = add_state!(chain)
    ...
    @testset "inftime_state_multiple_comps" begin
        chain = ContMarkovChain()
        t0 = add_state!(chain)
        t1 = add_state!(chain)
        t2 = add_state!(chain)
    ...
    @testset "inftime_state_multiple_comps_init_bottom" begin
        chain = ContMarkovChain()
        t0 = add_state!(chain)
        t1 = add_state!(chain)
        t2 = add_state!(chain)
